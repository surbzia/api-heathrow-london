                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="title" class="form-control" id="title">
                                        ...
                                        <option {{ $is_edit && $edit_user->title == 'Mr' ? 'selected' : ''}} value="Mr">Mr</option>
                                        <option  {{ $is_edit && $edit_user->title == 'Mrs' ? 'selected' : ''}} value="Mrs">Mrs</option>
                                        <option  {{ $is_edit && $edit_user->title == 'Miss' ? 'selected' : ''}} value="Miss">Miss</option>
                                        <option  {{ $is_edit && $edit_user->title == 'Dr' ? 'selected' : ''}} value="Dr">Dr</option>
                                        <option  {{ $is_edit && $edit_user->title == 'Sir' ? 'selected' : ''}} value="Sir">Sir</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first_name"
                                        value="{{ old('first_name', $edit_user->first_name) }}"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last_name"
                                        value="{{ old('last_name', $edit_user->last_name) }}"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email"
                                        ...
                                        value="{{ old('email', $edit_user->email) }}" name="email" placeholder="User Email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" id="description"
                                        class="form-control"
                                        value="{{ old('description', $edit_user->name) }}" name="description" placeholder="Description"> --}}
                                    <textarea name="description" id="description" class="form-control" cols="10" rows="5">
                                       {{ old('description', $edit_user->description) }}
                                    </textarea>
                                </div>
                            </div>
                             ...
                             <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="mobile_num"
                                                value="{{ old('mobile_num', $edit_user->mobile_num) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="emergency_num"
                                                value="{{ old('emergency_num', $edit_user->emergency_num) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="telephone_num"
                                                value="{{ old('telephone_num', $edit_user->telephone_num) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company_name"
                                                value="{{ old('company_name', $edit_user->company_name) }}"
                                    ...
                                    <div class="col-md-9 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address"
                                                value="{{ old('address', $edit_user->address) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city"
                                                value="{{ old('city', $edit_user->city) }}" class="form-control"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="county"
                                                value="{{ old('county', $edit_user->county) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country"
                                                value="{{ old('country', $edit_user->country) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="post_code"
                                                value="{{ old('post_code', $edit_user->post_code) }}"
